...
// import 'package:untitled7/screens/meterreading.dart';
                          ...
                          child: Padding(
                            ...
                            child:TextButton(
                             ...
                             {},
                              ...
                              child: const Text(
                                'Live Meter Reading ',textAlign: TextAlign.center,
                        ...
                        child: Container(
                          ...
                          child: Padding(
                              ...
                              child:TextButton(
                                onPressed: ()
                                {
                                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => meterread()));
                                },
                                style: TextButton.styleFrom(
                                  primary: Colors.white,
                                  // backgroundColor: Colors.black, // Background Color
                                ...
                                child: const Text(
                                  'Last Month Meter Reading ',textAlign: TextAlign.center,
                                  style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),
                                ),
                              )
                            //
                        ...
                        child: Container(
                          ...
                          child: Padding(
                              ...
                              child:TextButton(
                                ...
                                child: const Text(
                                  textAlign: TextAlign.center,
                                  'Request For Last Year Meter Reading',
                                  style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),
                                ),
                              )
                            //   TextButton(onPressed: ()=>{
